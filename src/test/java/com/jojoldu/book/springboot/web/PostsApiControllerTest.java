...
public class PostsApiControllerTest {
    ...
    @Test
    public void Posts_등록이_성공하면_테스트가_성공한다() throws Exception {
        // given
        String title = "woowa";
        String content = "course";
        String author = "fortune";
        ...
        String url = HTTP_LOCALHOST + port + "/api/v1/posts";
    ...
    @Test
    public void Posts수정이_수정이_수행되면_성공한다() throws Exception {
        ...
        String url = HTTP_LOCALHOST + port + "/api/v1/posts/" + updateId;
